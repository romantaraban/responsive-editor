...
(function (window) {
  ...
  var ResponsiveEditor = function (el, data, options) {
  ...
  ResponsiveEditor.prototype = {
    initEditor: function (holder) {
      ...
      this.body.innerHTML = '<div id="editor" class="responsive-editor break-' + this.currentBreakpoint + '"><div class="row-add"></div></div><link rel="stylesheet" href="' + this.cssPath + '">';
    ...
    renderTo: function (target) {
      var html = '';
        ...
        html +=
          ...
          + ((~~column.hideLarge) ? ' hide-for-large' : '') + ((~~column.hideMedium) ? ' hide-for-medium' : '') + ((~~column.hideSmall) ? ' hide-for-small' : '')
